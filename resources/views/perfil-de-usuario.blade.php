...
<div class="container-fluid">
    ...
    <main>
        ...
        <div class="user-info">
            <h2 class="user">Agustín Astudillo</h2>
            <p class="mail">agustin_9383@hotmail.com</p>
        </div>
        <div class="profile-options">
            <a class="profile-option" href="infoPersonal.php">
                Información personal
            </a>
            <a class="profile-option" href="datosPersonales.php">
                Datos de tu cuenta
            </a>
            <a class="profile-option" href="SeccionSeguridad.php">
                Seguridad
            </a>
            <a class="profile-option">
                Meli+
            </a>
            <a class="profile-option" href="tarjetasGuardadas.php">
                Tarjetas
            </a>
            <a class="profile-option" href="Direcciones.php">
                Direcciones
            </a>
            <a class="profile-option">
                Privacidad
